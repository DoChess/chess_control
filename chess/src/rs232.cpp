...
//char *comports[RS232_PORTNR] = {"/dev/rfcomm2","/dev/ttyS1","/dev/ttyS2","/dev/ttyS3","/dev/ttyS4","/dev/ttyS5",
...
string comports[] = {"/dev/rfcomm2","/dev/ttyS1","/dev/ttyS2","/dev/ttyS3","/dev/ttyS4","/dev/ttyS5",
                       "/dev/ttyS6","/dev/ttyS7","/dev/ttyS8","/dev/ttyS9","/dev/ttyS10","/dev/ttyS11",
                       "/dev/ttyS12","/dev/ttyS13","/dev/ttyS14","/dev/ttyS15","/dev/ttyUSB0",
                       "/dev/ttyUSB1","/dev/ttyUSB2","/dev/ttyUSB3","/dev/ttyUSB4","/dev/ttyUSB5",
                       "/dev/ttyAMA0","/dev/ttyAMA1","/dev/ttyACM0","/dev/ttyACM1",
...
*/
  ...
  Cport[comport_number] = open(comports[comport_number].c_str(), O_RDWR | O_NOCTTY | O_NDELAY);
...
int RS232_GetPortnr(const char *devname)
{
  ...
  {
    if(!strcmp(comports[i].c_str(), str))
    {
      return i;
    }
  }
